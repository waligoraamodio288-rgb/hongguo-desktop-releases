...
如果安装后始终无法播放，请在[播放问题 #5](https://github.com/waligoraamodio288-rgb/hongguo-desktop-releases/issues/5)补充点击播放后的表现（无反应、持续加载、黑屏或报错）和换剧结果；没有 GitHub 账号可发邮件至[项目邮箱](mailto:WaligoraAmodio288@gmail.com)。目前原因尚未确认。
